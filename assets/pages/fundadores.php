  ...
  <!-- Main content -->
        <div id="container" class="filter">
            <div class="Fundadores">
                <h1><i>Founder and CEO:</i> Yoshi Sora Manuel Sanchez</h1>
                <h2><i>Co-Founder and CEO:</i> Rolando Antonio Lopez Morales</h2>
                <h2><i>Co-Founder and CEO:</i> Omar Chiñas Jiménez</h2>
                <h2><i>Co-Founder and CEO:</i> Benjamin Alberto Garcia Jiménez </h2>
                <P>NavHer</P>
            </div>
        </div>
