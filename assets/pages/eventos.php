...
<body>
 <section  class="nav position-fixed top-0" id="navbar">
    <a
    style="width: 100%;"
    ...
    <div class="content">
        ...
        <article class="post position-relative">
            ...
            <div class="post-body">
                ...
                <h2>Cumpleaños</h2>
                <p class="descripcion">Lorem ipsum dolor sit amet consectetur adipisicing elit. Repellendus necessitatibus provident molestiae quo minus labore laborum dicta, iure, ullam dolore et at veniam tenetur enim ut. Suscipit aspernatur perspiciatis possimus?</p>
        ...
        <article class="post position-relative">
            ...
            <div class="post-body">
                <span>18 de diciembre</span>
                <h2>Fin del mundo</h2>
                <p class="descripcion">va a caer un meteorito y vamos a morir</p>
                <a href="#" class="post-link">Leer Mas...</a>
            </div>
        </article>
...
<div class="sidebar-2 position-fixed top-0" >
